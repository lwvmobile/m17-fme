...
Input Options:
  ...
  -^ <file>     IP Frame input file (from M17-FME IP Frame Decoder)
...
Output Options:
  ...
  -* <file>     IP Frame output file (from M17-FME IP Frame Decoder)
...
Encoder Input Strings:
  ...
  -A <str>      Enter SMS Message (Up to 48 ASCII characters) For Stream Voice Encoder (Arbitrary Data). Enables 1600 mode.
  ...
  -R <hex>      Enter RAW Data for Packet Data Encoder as Hex Octets (up to 823 octets).
                ...
                (example: -R ) for TLE Data) 
